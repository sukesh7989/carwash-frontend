...
function SUV(props) {
  ...
  return (
    ...
    <div className="sedan-container">
      ...
      <h4> <span>8</span> Days Outer Cleaning</h4>     
      <h4><span>10</span> DAys Tire Cleaning</h4>
      <h4><span>0</span> DAys Interior Cleaning</h4>
      <h4><span>1</span>  Free Foamwash</h4>
      <h4><span>0</span> Dashboard polish</h4>
      <button type='button'onClick={()=>{
            handleShow({service:"Lite",price:799})
          }}> Book Now</button>
    </div>
    <div className="sedan-container">
    ...
    <div className="sedan-container">
      ...
      <button type='button' onClick={()=>{
            handleShow({service:"Lite",price:1599})
          }}> Book Now</button>
    </div>
    <div className="sedan-container">
      ...
      <h4><span>4</span> DAys Interior Cleaning</h4>
      <h4><span>1</span>  Free Foamwash</h4>
      <h4><span>2</span> Dashboard polish</h4>
      <button type='button' onClick={()=>{
            handleShow({service:"Lite",price:2499})
          }}> Book Now</button>
    </div>
</div>
  )
